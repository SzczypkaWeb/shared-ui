...
- 35ce8c3: Fix two background-transparency regressions introduced by the earlier dark-mode contrast pass:
...
- 107a39c: Fix a `Modal` positioning bug and add a `size` prop for width/layout.
...
- a1d362d: Fix `Button` text wrapping in constrained flex layouts and add a new `Modal` component.
